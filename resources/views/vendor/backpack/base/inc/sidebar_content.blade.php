...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('department') }}'><i class='nav-icon la la-archive'></i>
        Departments</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('team') }}'><i class='nav-icon la la-users'></i> Teams</a>
</li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('team-detail') }}'><i
            class='nav-icon la la-info-circle'></i> Team details</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('profile-work') }}'><i
            class='nav-icon la la-pencil-square'></i> Profile works</a></li>
